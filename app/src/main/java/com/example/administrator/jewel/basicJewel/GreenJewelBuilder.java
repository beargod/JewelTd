 ...
 */
public class GreenJewelBuilder extends BasicJewelBuilder{
    private int quality;
    public GreenJewelBuilder(int quality){
        this.quality = quality;
        super.basicJewel.setQuality(quality);
    }
    public void buildSkill(){
        ArrayList skills = new ArrayList<JewelSkill>();
        JewelSkill skill = new PoisonSkill(1);
        skills.add(skill);
